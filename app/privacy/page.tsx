...
const PRIVACY_TR = (
  <div style={{maxWidth:750,margin:'60px auto',background:'#171c2d',borderRadius:22,padding:36,color:'#ffe18d',boxShadow:'0 10px 30px #0007'}}>
    <h1 style={{fontWeight:800,fontSize:'2.1rem',marginBottom:18}}>VERITAS AI GİZLİLİK SÖZLEŞMESİ VE POLİTİKASI</h1>
    <div style={{color:'#eaeaea',fontWeight:600,marginBottom:28, fontSize:'1.07rem'}}>
      <b>Son Güncelleme Tarihi: [Günün Tarihi]</b>
      <ol style={{ marginLeft: 18 }}>
        <li><b>Giriş ve Kapsam:</b> Bu Politika, Veritas AI ("Platform") kullanıcılarının kişisel verilerinin işlenmesinin usul ve esaslarını kapsar. Veritas AI, 6698 sayılı KVKK'ya ve uluslararası mevzuata tam uyumu taahhüt eder.</li>
        ...
        <li><b>Kullanıcı Hakları:</b> Kullanıcılar, Veritas AI'ya başvurarak verilerinin işlenip işlenmediğini öğrenme, düzeltme, silme ve yok edilmesini talep etme hakkına sahiptir.</li>
...
const PRIVACY_EN = (
  <div style={{maxWidth:750,margin:'60px auto',background:'#171c2d',borderRadius:22,padding:36,color:'#ffe18d',boxShadow:'0 10px 30px #0007'}}>
    <h1 style={{fontWeight:800,fontSize:'2.1rem',marginBottom:18}}>VERITAS AI PRIVACY POLICY</h1>
    <div style={{color:'#eaeaea',fontWeight:600,marginBottom:28, fontSize:'1.07rem'}}>
      <b>Last Updated: [Current Date]</b>
      <ol style={{ marginLeft: 18 }}>
        <li><b>Scope:</b> This Policy covers the processing of personal data of Veritas AI ("Platform") users and legal compliance (in particular, EU GDPR and Turkish law).</li>
        ...
        <li><b>User Rights:</b> You can request from Veritas AI: to learn whether your data is processed, request correction/deletion, and object to processing.</li>
