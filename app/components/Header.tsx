...
import { SUPPORTED_LANGUAGES, tr, getLanguage } from '@/lib/translations';
        ...
        {user && (
          <div style={{ position: 'relative' }} data-user-menu>
            <button
              ...
              title={user.user_metadata?.full_name || user.email || tr(language, 'userTitle')}
              data-lang-aware
            >
            ...
            {userMenuOpen && (
              <div style={{
                ...
                {canAccessHistory() && (
                  ...
                  >
                    <span>📋</span> {tr(language, 'myAnalyses')}
                  </button>
                )}
